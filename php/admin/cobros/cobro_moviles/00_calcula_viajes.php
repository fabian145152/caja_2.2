    ...
    <div class="form-container">
        <form>
            <div class="form-group">
                ...
                <input type="text" id="cant_viajes" name="cant_viajes" onblur="calcularYRestar()" required autofocus style='text-align: center; font-size: 18px; font-weight: bold; background-color: yellow;'>
            </div>
            ...
            <input type="hidden" id="resultadoMultiplicacion" readonly style='text-align: center; font-size: 18px; font-weight: bold;'>

            <div class="form-group">
                <label for="resultadoResta">Resultado:</label>
                <input type="text" id="resultadoResta" name="resultadoResta" style='text-align: center; font-size: 18px; font-weight: bold;' readonly>
            </div>
