...
<body>
    <div class="zoom-vertical">
        ...
        ?>
            ...
            if ($venta_2 != 0) {
            ?>
                <h5>Compro: <?php echo $row_venta_2['nombre'] . " " . "a" . " " . "$" . $ven_2 = $row_venta_2['precio'] ?>-</h5>
            <?php
            }
            if ($venta_3 != 0) {
            ?>
                <h5>Compro: <?php echo $row_venta_3['nombre'] . " " . "a" . " " . "$" . $ven_3 = $row_venta_3['precio'] ?>-</h5>
            <?php
            }
            if ($venta_4 != 0) {
            ?>
                <h5>Compro: <?php echo $row_venta_4['nombre'] . " " . "a" . " " . "$" . $ven_4 = $row_venta_4['precio'] ?>-</h5>
            <?php
            }

            if ($venta_5 != 0) {
            ?>
                <h5>Compro: <?php echo $row_venta_5['nombre'] . " " . "a" . " " . "$" . $ven_5 = $row_venta_5['precio'] ?>-</h5>
            <?php
            }
            if ($venta_1 != 0) {
            ?>

                <h5>Compro: <?php echo $row_venta_1['nombre'] . " " . "a" . " " . "$" . $ven_1 = $row_venta_1['precio'] ?>-</h5>
                <?php
                        ...
                        ?>
                            ...
                            ?>
                                ...
                                <input type="text" id="saldo_a_favor" name="saldo_a_favor" value="<?php echo $saldo_a_favor ?>"
                                    style="background-color: yellow; text-align: center;  font-weight: bold; font-size: 20px" readonly>
                            <?php
                            }
                            ...
                            if ($deu_ant > 0 || $cant_sem > 1 || $total_ventas > 1) {
                                ...
                                ?>
                                    ...
                                    <input type="text" id="deuda_ant" name="deuda_ant" value="<?php echo $deu_ant ?>"
                                        style="background-color: orange; color: black; text-align: center;  font-weight: bold; font-size: 20px" readonly>
                                <?php
                                }
                                ?>
                                <br>
                        ...
                        <ul style="border: 2px solid black; padding: 5px; border-radius: 10px; list-style-type: none;">
                            ...
                            <li>
                                ...
                                if ($saldo_recuento < 0) {
                                    ...
                                    echo "No debe abonar nada. Está al dia: " . $saldo_recuento;
                                    echo "<br>";
                                } else if ($saldo_recuento > 0) {
